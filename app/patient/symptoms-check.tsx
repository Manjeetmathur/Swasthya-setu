...
export default function SymptomsCheck() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      text: 'Hello! I can help you understand your symptoms. Describe what you\'re experiencing and I\'ll provide guidance (not a diagnosis). Please remember to consult a doctor for proper medical evaluation.',
      isUser: false,
      timestamp: new Date()
    }
  ])
  ...
  const handleSendMessage = async () => {
    ...
    try {
      const medicalResponse = await geminiMedicalService.getMedicalResponse(currentQuery, 'symptoms')
      ...
      console.error('Symptoms Check Error:', error)
