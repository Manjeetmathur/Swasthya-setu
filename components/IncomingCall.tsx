    ...
    >
      <View className="flex-1 bg-gradient-to-b from-blue-900 to-blue-700 items-center justify-center">
        ...
        <View className="absolute items-center justify-center">
          <View className="w-80 h-80 border-2 border-white/30 rounded-full animate-pulse" />
          <View className="absolute w-96 h-96 border-2 border-white/20 rounded-full animate-pulse" 
        ...
        <View className="absolute bottom-20 left-0 right-0">
          <View className="flex-row justify-center items-center space-x-16">
            ...
            >
              {isDeclining ? (
                <View className="w-6 h-6 border-2 border-white rounded-full animate-spin border-t-transparent" />
              ) : (
